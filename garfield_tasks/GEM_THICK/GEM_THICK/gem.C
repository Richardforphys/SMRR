...
int main(int argc, char * argv[]) {
  ...
  if (plotField) {
    ...
    fieldView->SetArea(-pitch / 2., -0.3, pitch / 2., 0.1);
    fieldView->SetVoltageRange(-2500., 0.);
  ...
  std::cout << "Total multiplied electrons= " << sumElectronMultiplied << "\n";
  sumElectronMultiplied=0.;
  }
